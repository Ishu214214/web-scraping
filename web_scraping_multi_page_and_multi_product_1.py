...
def Product_Page_(n ,name_product , Page_number):

    
    Product_page(n ,name_product)
...
def getdata(a2 ):
    ...
    browser.get('https://www.amazon.in/s?k=' )                 
    time.sleep(2)
    ...
    with open('file_name_'+ a2+ '_1.html', 'wt', encoding='utf-8') as file:
    ...
    time.sleep(2)
    element = browser.find_element("xpath",'//a[text()="2"]')
    element.click()
    time.sleep(2)

    with open('file_name_'+ a2+ '_2.html', 'wt', encoding='utf-8') as file:
        for line in soup.prettify():
            file.write(line)    
    ...
    time.sleep(2)
    element = browser.find_element("xpath",'//a[text()="3"]')
    element.click()
    time.sleep(2)

    with open('file_name_'+ a2+ '_3.html', 'wt', encoding='utf-8') as file:
        for line in soup.prettify():
            file.write(line)
...
for i in range(0,1 ):
    ...
    mobile1=threading.Thread(target=getdata , args=[ name_product_1 ] )
    book1=threading.Thread(target=  getdata   ,   args=[name_product_2 ])
    bottal1=threading.Thread(target=getdata , args=[name_product_3 ])
...
#     name_product_page_1 = "file_name_" + name_product_1 + "_" + str(i+1)  + ".html"
#     name_product_page_2 = "file_name_" + name_product_2 + "_" + str(i+1)  + ".html"
#     name_product_page_3 = "file_name_" + name_product_3 + "_" +  str(i+1) + ".html"

#     print()


#     mobile1=threading.Thread(target=Product_Page_, args=[ name_product_page_1,name_product_1 , i+1 ] )
#     book1=threading.Thread(target=Product_Page_,   args=[name_product_page_2 ,name_product_2  , i+1])
#     bottal1=threading.Thread(target=Product_Page_, args=[name_product_page_3 ,name_product_3  , i+1])
